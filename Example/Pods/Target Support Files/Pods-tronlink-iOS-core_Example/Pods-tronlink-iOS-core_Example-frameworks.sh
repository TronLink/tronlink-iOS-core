...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TronWalletABI/TronCore.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TronWalletKeystore/TronKeystore.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TronWalletWeb3Swift/web3swift.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/tronlink-iOS-core/TLCore.framework"
fi
