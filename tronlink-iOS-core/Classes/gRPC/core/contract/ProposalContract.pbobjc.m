...
GPBObjCClassDeclaration(ProposalApproveContract);
GPBObjCClassDeclaration(ProposalCreateContract);
GPBObjCClassDeclaration(ProposalDeleteContract);
...
static GPBFileDescription ProposalContractRoot_FileDescription = {
    .package = "protocol",
    .prefix = NULL,
...
+ (GPBDescriptor *)descriptor {
    ...
    if (!descriptor) {
        ...
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(ProposalApproveContract)
                                   messageName:@"ProposalApproveContract"
                               fileDescription:&ProposalContractRoot_FileDescription
                                        fields:fields
...
+ (GPBDescriptor *)descriptor {
    ...
    if (!descriptor) {
        ...
        GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(ProposalCreateContract)
                                   messageName:@"ProposalCreateContract"
                               fileDescription:&ProposalContractRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
    ...
    if (!descriptor) {
        ...
        GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(ProposalDeleteContract)
                                   messageName:@"ProposalDeleteContract"
                               fileDescription:&ProposalContractRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
