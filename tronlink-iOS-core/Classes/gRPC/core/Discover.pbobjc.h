...
typedef GPB_ENUM(Endpoint_FieldNumber) {
    ...
    Endpoint_FieldNumber_AddressIpv6 = 4,
};
...
@property(nonatomic, readwrite, copy, null_resettable) NSData *addressIpv6;
...
/** The number of items in @c neighboursArray without causing the container to be created. */
